  ...
  return (
    <main>
      ...
      <section className="relative h-105 bg-linear-to-br from-blue-600 to-blue-800 text-white flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mt-4">
            Manage students, teachers, attendance, exams, fees, and online
            learning — all from a single intelligent dashboard.
          </p>
      ...
      <section className="py-20 bg-white px-6">
        ...
        >
          <Image src="/SIS.png" alt="School SIS UI" width={1600} height={900} />
        </motion.div>
      </section>
      ...
      <section className="py-20 bg-blue-50 px-6">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
          Auto-generate timetables and instantly track attendance with
          biometric, QR code or mobile-based systems.
        </p>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white text-center px-6">
        ...
        <p className="max-w-2xl mx-auto text-lg mb-8">
          Get a personalized demo and see how our School Management System can
          simplify operations.
        </p>
